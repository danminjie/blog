...
<html lang="zh-CN">
 ...
 <body id="wrap" class="search search-results"> 
  ...
  <header class="header-wrap" id="nav-scroll"> 
    ...
    <!-- Main Wrap --> 
    <div class="login_box">
      <div class="login_l_img"><img src="{{ asset('home/images/email.png') }}" /></div>
      <div class="login" style="margin-top: 125px;">
          ...
          <form method="post" action="{{ url('dotuiding') }}" method="post" onSubmit="return tijiao();">
            {{ csrf_field() }}
              <input id="user_name" name="user_name" type="text" lay-verify="email"
                  autocomplete="off"  placeholder="请输入需要退订的邮箱">
              <input id="yanzhengma" value="确认退订" style="width:100%;" type="submit">
          </form>
      </div>
</div>
