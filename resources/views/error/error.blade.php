...
<h1 class="glyphicon glyphicon-exclamation-sign" style="color:#F33"><p class="error">{{ $msg }}</p></h1>
<br />
<a href="login">跳转到登录页</a> <a style="margin-left: 100px;" href="register">跳转到注册页</a>
</present>
<p class="detail"></p>
</div>
</body>
