        ...
        <form class="layui-form" action="{{ url('admin/role/doauth') }}" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" value="{{$role->role_name}}" readonly class="layui-input">
              </div>
              ...
              <div class="layui-input-block">
                @foreach($per as $v)
                  @if(in_array($v->id,$own_pers))
                    <input type="checkbox" checked name="permission_id[]" lay-skin="primary" value="{{$v->id}}" title="{{$v->per_name}}" >
                  @else
                    <input type="checkbox" name="permission_id[]" lay-skin="primary" value="{{$v->id}}" title="{{$v->per_name}}" >
                  @endif
                @endforeach
              </div>
