...
jQuery(document).ready(function(a) {
    var b = a("#sign");
    a("#register-active").on("click",
    function() {
        b.removeClass("sign").addClass("register")
    }),
    a("#login-active").on("click",
    function() {
        b.removeClass("register").addClass("sign")
    }),
    a(".user-login,.user-reg").on("click",
    function(c) {
        ...
        a("div.overlay, form a.close").on("click",
        function() {
    ...
    a("form#login, form#register").on("submit",
    function(b) {
